<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastrarCurso.aspx.cs" Inherits="Estagio2.DashBoard.CadastrarCurso" %>
                                            ...
                                            <div class="col-md-6">
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <asp:TextBox ID="txtNomeCurso" runat="server" placeholder="Nome do Curso" Width="180%"></asp:TextBox>
                                            ...
                                            <div class="col-md-3" >
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <asp:TextBox ID="txtDataInicial" runat="server" Width="130%"></asp:TextBox>
                                                        <div class="row">
                                                            <asp:RequiredFieldValidator
                                            ...
                                            <div class="col-md-3" >
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <asp:TextBox ID="txtDataFinal" runat="server" Width="130%"></asp:TextBox>
                                                        <div class="row">
                                                            <asp:RequiredFieldValidator
                                            ...
                                            <div class="col-md-8" >
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <asp:TextBox ID="txtCargaHoraria" runat="server" Width="30%" TextMode="Number"></asp:TextBox>
                                                        <asp:RequiredFieldValidator
                                            ...
                                            <div class="col-md-8">
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <textarea id="txtDescricaoCurso" runat="server" cols="70" rows="4"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 login-right">
                                                <div class="wow fadeInRight" data-wow-delay="0.4s">                                     
                                                    <asp:Button ID="btnCadastrarCurso" runat="server" Text="Cadastrar" OnClick="btnCadastrarCurso_Click"></asp:button>
                                                    <br />
                                                </div>
                                                <br />
                                                <p>
