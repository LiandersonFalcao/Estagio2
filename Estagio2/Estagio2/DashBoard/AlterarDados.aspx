<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlterarDados.aspx.cs" Inherits="Estagio2.DashBoard.MudarSenha" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Alterar Dados
                            </li>
                        </ol>
                    </div>
                    <div class="content">
                                    ...
                                    <form runat="server"> 
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <asp:TextBox ID="txtNomeInstrutor" runat="server" placeholder="Nome Completo" Width="180%"></asp:TextBox>
                                                        <asp:RequiredFieldValidator
                                                            ID="RequiredNome" runat="server"
                                                            ControlToValidate="txtNomeInstrutor"
                                            ...
                                            <div class="col-md-8">
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <asp:TextBox ID="txtEmailInstrutor" runat="server" placeholder="Email Válido" Width="100%"></asp:TextBox>
                                                        <div class="row">
                                                            <asp:RequiredFieldValidator
                                                                ID="RequiredEmail" runat="server"
                                                                ControlToValidate="txtEmailInstrutor"
                                                                ErrorMessage="Campo Obrigatório!"
                                                                ForeColor="Red"
                                                                Display="Dynamic">
                                                            </asp:RequiredFieldValidator>
                                            ...
                                            <div class="col-md-8">
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        ...
                                                        <asp:TextBox ID="txtLogin" runat="server" placeholder="Login" Width="80%"></asp:TextBox>
                                                        <div class="row">
                                                            <asp:RequiredFieldValidator
                                            ...
                                            <div class="col-md-6 login-right">
                                                <div class="wow fadeInRight" data-wow-delay="0.4s">                                     
                                                    <asp:Button ID="btnCadastrarCurso" runat="server" Text="Salvar Alteração" OnClick="btnAlterarInstrutor"></asp:button>
                                                    <br />
                                                </div>
                                                <br />
                                                <p>
