<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Estagio2.DashBoard.index" %>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a id="Certificados" href="javascript:;" data-toggle="collapse" data-target="#ulcertificados"><i class="fa fa-fw fa-user"></i>Certificados<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="ulcertificados" class="collapse">
                            <li>
                                <a href="CadastrarCertificado.aspx">Cadastrar Certificados</a>
                            </li>
                            <li>
                                <a href="AlterarCertificado.aspx">Alterar Certificados</a>
                            </li>
                            <li>
                                <a href="GerarCertificado.aspx">Gerar Certificados</a>
                            </li>
                        </ul>
                    </li>
                    <!--<li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Tela de Bem Vindo <small>Vai ter alguma coisa aqui...</small>
                        </h1>
                        <%--<ol class="breadcrumb">
                            <li class="active">
