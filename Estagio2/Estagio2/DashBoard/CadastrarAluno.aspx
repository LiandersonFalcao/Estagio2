<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastrarAluno.aspx.cs" Inherits="Estagio2.DashBoard.CadastrarAluno" %>
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-6 login-right">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">  
                                                        ...
                                                        <asp:Button ID="btnCadastroAluno" runat="server" Text="Selecionar" OnClick="btnMostrarCadastro"></asp:button>
                                                        <br /><br />
                                                        <p>
                                        ...
                                        <asp:Panel ID="pnlDados" runat="server">
                                            <div class="col-md-8">
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                                                        <span><b>Nome do Aluno<label>*</label></b></span>
                                                        <asp:TextBox ID="txtNomeAluno" runat="server" placeholder="Nome do Aluno" Width="180%"></asp:TextBox>
                                                        <asp:RequiredFieldValidator
                                                            ID="RequiredNomeCurso" runat="server"
                                                            ControlToValidate="txtNomeAluno"
                                            ...
                                            <div class="col-md-8">
                                                <div class="register-top-grid">
                                                    <div class="wow fadeInRight" data-wow-delay="0.4s">
						                             ...
						                             <asp:TextBox ID="txtEmailAluno" runat="server" placeholder="Email Válido"></asp:TextBox>
                                                     <asp:RequiredFieldValidator
                                                        ID="RequiredEmail" runat="server"
                                                        ControlToValidate="txtEmailAluno"
                                            ...
                                            <div class="col-md-6 login-right">
                                                <div class="wow fadeInRight" data-wow-delay="0.4s">                                     
                                                    <asp:Button ID="btnCadastrarAluno" runat="server" Text="Cadastrar" OnClick="btnCadastrarAluno_Click"></asp:button>
                                                    <br />
                                                </div>
                                                <br />
                                                </div>
